...
(deftest initialize-pivot-selection-vector (gauss)
  (assert-true (num= #(0 1 2 3 4 5) (linear-algebra-kernel::initialize-pivot-selection-vector 6))))
...
(deftest swap-rows (gauss)
  (assert-true (num= #2A((1.3 2.3 3.3 3.2)
			 (1.4 2.2 2.3 2.1)
			 (1.1 1.4 1.3 1.2)
			 (1.2 2.1 3.2 4.4))
...
(deftest column-pivot (gauss)
  (let ((psv (linear-algebra-kernel::initialize-pivot-selection-vector 4))
    ...
    (multiple-value-bind (array0 psv0)
      ...
      (assert-eq psv psv0)
      (assert-true (num= #(1 0 2 3) psv0))
      (assert-true (num= #2A((1.4 2.2 2.3 2.1)
...
(deftest gauss-solver (gauss)
    ...
    (assert-true (num= #(66.36775 -151.8342 85.6118)
		       (linear-algebra-kernel:gauss-solver (make-array '(3 3) :initial-contents '((1.15 1.26 1.37) (2.14 2.23 2.31) (3.13 3.22 3.31)))
