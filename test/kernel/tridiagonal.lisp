...
(deftest tridiagonal-factorization (kernel)
  (assert-true (num= #2A((0.0  1.1        1.2727273)
...
(deftest tridiagonal-update (kernel)
  (assert-true (num= #(1.0909091 6.630434 1.3850269 -0.24240965)
...
(deftest tridiagonal-backsubstitution (kernel)
  (assert-true (num= #(1.7666159 -0.5309124 1.3020632 -0.24240965)
...
(deftest tridiagonal-solver (kernel)
  (assert-true (num= #(1.7666159 -0.5309124 1.3020632 -0.24240965)
		     (linear-algebra-kernel:tridiagonal-solver (make-array '(4 3) :initial-contents '((0.0 1.1 1.4)
												      (1.4 2.2 2.3)
												      (2.3 3.3 3.2)
												      (3.2 4.4 0.0)))
							       (make-array 4 :initial-contents '(1.2 4.3 2.3 3.1))))))
