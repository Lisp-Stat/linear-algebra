  ...
  (loop
    ...
    do
	 ...
	 as element = (/ (- (aref array index-k index-j)
			 ...
			 (aref array index-j index-j))
	 do (setf (aref array index-k index-j) element (aref array index-j index-k) element))
...
(defun hermitian-cholesky-decomposition (array)
  ...
  (loop
    ...
    do
       ;; Step 1.1
       (setf (aref array index-j index-j) (sqrt
					   (- (aref array index-j index-j)
					      (loop
...
decomposition."
  (loop
    ...
    with array^-1 = (make-array (array-dimensions array) :element-type element-type
